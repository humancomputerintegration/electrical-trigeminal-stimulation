...
public class AnsysPlume : MonoBehaviour
{
    ...
    public int plumeFrame = 1;
    public string path = "/AnsysBoundingVolumes/Box_i4_j0_k4/"; // "/data/smoke_3/upsampled/point_"
    ...
    {
        string framePath = (Application.streamingAssetsPath + path + frameNumber.ToString() + ".csv");
